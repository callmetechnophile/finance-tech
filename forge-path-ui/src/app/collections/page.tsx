    ...
    <AppShell>
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="bg-[#111827] border border-[#1E253E] rounded-2xl overflow-hidden">
          <div className="p-4 border-b border-[#1E253E] flex gap-3">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[#1E253E] text-[10px] uppercase font-bold text-[#6B7280]">
          ...
          {selectedInvoice && (
            <>
              ...
              <motion.div
                ...
                className="fixed right-0 top-0 h-full w-full max-w-lg bg-[#111827] border-l border-[#1E253E] shadow-2xl z-50 overflow-y-auto p-6 space-y-6"
              >
                <div className="flex justify-between items-center pb-4 border-b border-[#1E253E]">
                  <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 rounded-xl bg-[#0d1625] border border-[#1E253E] space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full h-24 bg-[#111827] border border-[#1E253E] rounded-lg p-2.5 text-xs text-[#9CA3AF] focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-[#0d1625] border border-[#1E253E] space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full h-20 bg-[#111827] border border-[#1E253E] rounded-lg p-2.5 text-xs text-[#9CA3AF] focus:outline-none"
                    />
                  </div>
                </div>
              </motion.div>
