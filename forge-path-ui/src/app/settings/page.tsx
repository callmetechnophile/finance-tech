  ...
  return (
    <AppShell>
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        {/* Setting Tabs */}
        <div className="flex gap-2 border-b border-[#1f2d44] pb-px">
        ...
        {activeTab === "company" && (
          <div className="p-6 rounded-2xl bg-[#111827] border border-[#1f2d44] max-w-2xl space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" defaultValue="Apex Manufacturing Inc." className="w-full px-3 py-2 bg-[#0d1625] border border-[#1f2d44] rounded-lg text-xs text-white" />
              </div>
              <div>
                <label className="block text-[10px] uppercase font-bold text-[#6B7280] mb-2">Industry Verticals</label>
                <input type="text" defaultValue="CNC & Steel Fabrication" className="w-full px-3 py-2 bg-[#0d1625] border border-[#1f2d44] rounded-lg text-xs text-white" />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input type="password" value={nvidiaKey} onChange={(e) => setNvidiaKey(e.target.value)} className="w-full pl-3 pr-10 py-2 bg-[#0d1625] border border-[#1f2d44] rounded-lg text-xs text-white" />
              ...
              <div>
                ...
                <input type="password" defaultValue="••••••••••••••••" className="w-full px-3 py-2 bg-[#0d1625] border border-[#1f2d44] rounded-lg text-xs text-white" />
              </div>
